...
export const TimeLast: React.FC<{ vmData: VMInstanceDataType }> = ({vmData}) => {
    ...
    const [notExpire, setNotExpire] = useState<boolean>(vmData._notExpire);
            ...
            <Row className="justify-content-center align-content-center">
                ...
                <Col xs={12}>
                    <Button variant={enableExtend ? "primary" : "outline-primary"}
                            className="w-100 rounded-5" href={"https://vpn.cocomine.cc/" + vmData._id + "#extendTime"}
                            target="_blank"
                            disabled={!enableExtend || notExpire}>
